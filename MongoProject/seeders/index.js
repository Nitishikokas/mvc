...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      'password':'f7B78WUtjmcd6hA',
      'isDeleted':false,
      'username':'Cole68',
      'email':'Kaleigh.Prohaska@gmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let user = await dbService.updateOne(User, { 'username':'Cole68' }, userToBeInserted,  { upsert: true });
    userToBeInserted = {
      'password':'0NeP1UMVZ3COi4p',
      'isDeleted':false,
      'username':'Marietta.Schuppe4',
      'email':'Colton.Bednar60@hotmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let admin = await dbService.updateOne(User, { 'username':'Marietta.Schuppe4' }, userToBeInserted,  { upsert: true });
