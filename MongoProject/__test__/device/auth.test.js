...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Chanelle95',
      password: 'OHrnduwcO5vSuev',
      email: 'Johann24@gmail.com',
      name: 'Douglas Kirlin',
      userType: 873,
      mobileNo: '(129) 966-7653',
      resetPasswordLink: {},
      loginRetryLimit: 915,
      loginReactiveTime: '2024-07-26T19:54:24.323Z',
      id: '65d72cb5fd4635078da80804'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Jamel_Murray',
        'password':'O2p8nk7g95RGkyq',
        'email':'Karen34@yahoo.com',
        'name':'Darnell Huel',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(174) 986-8458',
