...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Jarrett.Padberg18',
      password: 'P3xWCBBpci_m26d',
      email: 'Joanny_Bauch@gmail.com',
      name: 'Sherman Strosin',
      userType: 392,
      mobileNo: '(588) 890-6693',
      resetPasswordLink: {},
      loginRetryLimit: 656,
      loginReactiveTime: '2024-08-11T20:55:38.708Z',
      id: '65d72cb5fd4635078da807e3'
    });
  }
  catch (error) {
  ...
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        ...
        'password':'dWEbvTBiSXVnsQU',
        'email':'Russ.Schroeder90@hotmail.com',
        'name':'David Boyle',
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'(993) 828-4497',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Russ.Schroeder90@hotmail.com', });
